...
#warning To protect potentially sensitive information in your connection string, you should move it out of source code. You can avoid scaffolding the connection string by using the Name= syntax to read it from configuration - see https://go.microsoft.com/fwlink/?linkid=2131148. For more guidance on storing connection strings, see http://go.microsoft.com/fwlink/?LinkId=723263.
        ...
        protected override void OnModelCreating(ModelBuilder modelBuilder)
        {
            modelBuilder.Entity<Account>(entity =>
            {
                ...
                entity.HasIndex(e => e.Username, "UQ__Account__536C85E4DADFFD01")
                    .IsUnique();
            ...
            modelBuilder.Entity<Employee>(entity =>
            {
                ...
                entity.HasIndex(e => e.IdentityNumber, "UQ__Employee__6354A73F682075DA")
                    .IsUnique();

                entity.HasIndex(e => e.PhoneNumber, "UQ__Employee__85FB4E38CC606A25")
                    .IsUnique();
            ...
            modelBuilder.Entity<Product>(entity =>
            {
                ...
                entity.HasIndex(e => e.Barcode, "UQ__products__C16E36F8C426418A")
                    .IsUnique();
